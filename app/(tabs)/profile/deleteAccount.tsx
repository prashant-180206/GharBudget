...
const DeleteAccountScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-primary">
      ...
      >
        {/* White Layer */}
        <View className="bg-col_bg-light rounded-t-[40px] pt-6 px-6 pb-2 mt-20 min-h-[100vh]">
          {/* Header Row */}
          <View className="flex-row justify-between items-center mb-6">
            <View className="w-6" />
            <Text className="text-heading font-bold text-base">Delete Account</Text>
            <Ionicons name="person" size={24} color="#031314" />
          </View>

          {/* Confirmation Prompt */}
          <Text className="text-heading font-bold text-center text-sm mb-6">
          ...
          <View className="bg-[#d9f5e4] rounded-2xl px-5 py-6 mb-6">
            <Text className="text-heading text-sm mb-4">
              This action will permanently delete all of your data, and you
              will not be able to recover it. Please keep the following in mind
              before proceeding:
            </Text>
          ...
          {/* Password Input */}
          <View className="bg-[#d9f5e4] flex-row items-center rounded-2xl px-4 py-3 mb-6">
            <TextInput
          ...
          <TouchableOpacity
            ...
            className="bg-[#d9f5e4] rounded-full py-4"
          >
            <Text className="text-heading text-center font-bold text-sm">
              Cancel
            </Text>
