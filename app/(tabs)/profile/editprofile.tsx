  ...
  return (
    <>
      ...
      <SafeAreaView className="flex-1 bg-primary">
        <View className="absolute top-0 left-0 right-0 items-center mt-10 z-10">
          <Image
            source={{
              uri: "https://storage.googleapis.com/tagjs-prod.appspot.com/v1/uyT08IJT10/3nep5690_expires_30_days.png",
            }}
        ...
        <ScrollView className="flex-1 bg-col_bg absolute bottom-0 w-full h-[90%] rounded-t-[60px] pt-20 px-6 z-0">
          ...
          <View className="mb-6">
            ...
            <TextInput
              ...
              className="bg-col_bg-dark rounded-lg px-4 py-3 text-Txt"
            />
          </View>
